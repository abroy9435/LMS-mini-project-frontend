    ...
    return (
      <div className="bg-white border border-outline-variant p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="flex items-end gap-2 mb-3">
          <span className="font-display-lg text-display-lg text-on-surface leading-none">{used < 10 ? `0${used}` : used}</span>
          <span className="font-body-md text-on-surface-variant mb-1">/ {total < 10 ? `0${total}` : total} days</span>
        </div>
